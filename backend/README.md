...
## Project Structure
    ...
    ├── mobile_apps_studio__27496  # Django project configurations
...
1. Clone this repo and `cd mobile_apps_studio__27496`
...
2. Clone this repo and `cd mobile_apps_studio__27496`
